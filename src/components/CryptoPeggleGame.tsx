    ...
    const loop = () => {
      ...
      if (g.phase === 'firing') {
        ...
        for (let ballIdx = 0; ballIdx < g.balls.length; ballIdx++) {
          ...
          if (!inBubbleU && !inSpbhEcho) ball.vy += effGrav;
