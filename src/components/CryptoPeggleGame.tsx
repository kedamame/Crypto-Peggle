  ...
  return (
    ...
    >
      ...
      {(phase === 'aiming' || phase === 'firing') && (
        <>
          <div style={{ position: 'absolute', top: 76, left: '50%', transform: 'translateX(-50%)', pointerEvents: 'none', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 2 }}>
          ...
          <div style={{ position: 'absolute', top: 40, left: '50%', transform: 'translateX(-50%)', pointerEvents: 'all', display: 'flex', gap: 8 }}>
            <button
